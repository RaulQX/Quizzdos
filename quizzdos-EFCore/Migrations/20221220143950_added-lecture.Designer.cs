...
namespace quizzdos_EFCore.Migrations
{
    ...
    [Migration("20221220143950_added-lecture")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("quizzdos_EFCore.Entities.Courses.Lecture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("quizzdos_EFCore.Entities.Users.QuizzMate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CurrentPersonId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("quizzdos_EFCore.Entities.Courses.Quizz", b =>
                {
                    ...
                    b.HasOne("quizzdos_EFCore.Entities.Courses.Lecture", null)
                        .WithMany("Quizzes")
            ...
            modelBuilder.Entity("quizzdos_EFCore.Entities.Users.QuizzMate", b =>
                {
                    b.HasOne("quizzdos_EFCore.Entities.Users.Person", "QuizzMatePerson")
                        .WithMany()
                        .HasForeignKey("FriendId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("quizzdos_EFCore.Entities.Users.Person", "CurrentPerson")
                        .WithMany("Quizzmates")
                        .HasForeignKey("PersonId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
